...
async def start_command(message: Message, state: FSMContext):
    ...
    if pd:
        ...
        welcome_text = (
            ...
            "🛡️ <b>Безопасно</b> - исправная техника: \n"
            "🪖 Шлем\n"
            "⛓️ Цепь\n"
            "🎒 Термокороб\n"
            "🧳 Багажник\n"
            ...
            "—————————————————\n"
            "📌 <b>Как начать?</b>\n"
            "1️⃣ Приходите на базу: <i>г. Краснодар, ул. Корницкого, 47</i> 📍\n"
            "2️⃣ Выбирайте скутер - парк всегда обновляется 🔄\n"
            "3️⃣ Подписываете договор - и получаете ключи! 🚀\n\n"

            "—————————————————\n"
            "⏰ <i>Режим работы: пн-вс, 10:00-20:00</i>\n"
            "❓ Есть вопросы? Жмите «Поддержка» 💬"
        )
        ...
        text = (
            ...
            "4️⃣ Получаете ключи! 🔑\n\n"
            "—————————————————\n"
            "💎 <i>Анкета занимает всего минуту!</i>\n"
        )
